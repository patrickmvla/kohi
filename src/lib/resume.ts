...
export const resume: Resume = {
  ...
  socials: [
    ...
    { label: "LinkedIn", href: "https://www.linkedin.com/in/patrickmvla" },
  ...
  skills: [
    ...
    {
      title: "Backend & APIs",
      items: ["Node.js", "Express.js", "Gin", "Hono", "REST APIs"],
    },
    {
  ...
  projects: [
    {
      ...
      bullets: [
        ...
        "Steady cadence with deliberate, longform discussion.",
        "Drizzle schema for films, programs, and notes; TMDB ingestion.",
        "Realtime club updates via Supabase Realtime.",
        "Email invites/roundups through Resend; distraction‑free UX.",
      ],
      stack: ["Supabase", "Supabase Realtime", "Drizzle ORM", "Resend", "TMDB"],
      link: "https://eiiga.vercel.app",
    },
    {
    ...
    },
    {
      ...
      link: "https://prompt-studio-liard.vercel.app",
    },
    {
      title: "LinkLift",
