    ...
    <section className="section">
      <div className="container">
        <div className="relative">
          ...
          <p className="text-xs uppercase tracking-widest text-zinc-500">kohi a portfolio by patrick mvula — software engineer</p>
          ...
          <p className="mt-6 max-w-2xl text-base text-zinc-400 sm:text-lg">
            I design and ship systems that favor clarity, durability, and performance. Explore in‑depth
            projects, field notes, and what’s shaping my thinking.
          </p>
          ...
          <div className="mt-10 grid gap-6 text-sm text-zinc-400 sm:grid-cols-3">
            <div className="rounded-lg surface p-4">
              ...
              <div className="mt-1 text-zinc-200">Web platforms, DX, performance</div>
            </div>
            <div className="rounded-lg surface p-4">
              <div className="text-xs text-zinc-500">Currently</div>
              <div className="mt-1 text-zinc-200">Next.js, TypeScript, Edge, Postgres</div>
            </div>
            <div className="rounded-lg surface p-4">
              <div className="text-xs text-zinc-500">Availability</div>
              <div className="mt-1 text-zinc-200">Open to select collaborations</div>
            </div>
          </div>
        </div>
      </div>
