    ...
    <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4">
      <div className="grid gap-3 sm:grid-cols-2">
        <div>
          ...
          <input
            {...register("title")}
            className="mt-1 w-full rounded-md border border-white/10 bg-transparent px-3 py-2"
          />
          {errors.title && (
        ...
        <div>
          ...
          <input
            {...register("slug")}
            className="mt-1 w-full rounded-md border border-white/10 bg-transparent px-3 py-2 lowercase"
          />
          {errors.slug && (
      ...
      <div>
        ...
        <textarea
          {...register("content")}
          rows={12}
          className="mt-1 w-full rounded-md border border-white/10 bg-transparent px-3 py-2 font-mono"
        />
      </div>
